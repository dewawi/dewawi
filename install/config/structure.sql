...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `priceruleamount` decimal(15,4) NOT NULL,
  `priceruleaction` varchar(255) NOT NULL,
  `paymentmethod` varchar(255) NOT NULL,
  `paymentterm` varchar(255) NOT NULL,
  `cashdiscountdays` int(11) NOT NULL,
  `cashdiscountpercent` decimal(9,4) NOT NULL,
  `clientid` int(11) NOT NULL,
  `created` datetime NOT NULL,
  `createdby` int(11) NOT NULL,
  `modified` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `minquantity` decimal(15,4) NOT NULL,
  `orderquantity` decimal(15,4) NOT NULL,
...
CREATE TABLE `pricerule` (
  ...
  `itemsubcat` int(11) NOT NULL,
  `itemtype` varchar(255) NOT NULL,
  `itemmanufacturer` varchar(255) NOT NULL,
  `contactcatid` int(11) NOT NULL,
  `contactsubcat` int(11) NOT NULL,
  `clientid` int(11) NOT NULL,
  `created` datetime NOT NULL,
  `createdby` int(11) NOT NULL,
  `modified` datetime NOT NULL,
