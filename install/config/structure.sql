...
CREATE TABLE IF NOT EXISTS `creditnote` (
  ...
  `pdfshowprices` tinyint(1) NOT NULL DEFAULT 0,
  `pdfshowdiscounts` tinyint(1) NOT NULL DEFAULT 0,
  `pdfshowoptions` tinyint(1) NOT NULL DEFAULT 0,
  `pdfshowattributes` tinyint(1) NOT NULL DEFAULT 0,
  `pdfshowcover` tinyint(1) NOT NULL DEFAULT 0,
  `pdfshowimages` tinyint(1) NOT NULL DEFAULT 0,
  `pdfshowpositionimages` tinyint(1) NOT NULL DEFAULT 0,
  `language` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `email` (
  ...
  `suppressionreason` varchar(32) DEFAULT NULL,
  `suppresseddate` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ledger` (
  ...
  `referencemodule` varchar(50) DEFAULT NULL,
  `referencetype` varchar(50) DEFAULT NULL,
  `referenceid` int(11) DEFAULT NULL,
  `referencepositionid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `amazoncatid` int(11) DEFAULT NULL,
  `shopid` int(11) NOT NULL,
  `sku` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pricerule` (
  ...
  `contactcatid` int(11) DEFAULT NULL,
  `contactsubcat` int(11) NOT NULL DEFAULT 0,
  `clientid` int(11) NOT NULL,
  `created` datetime DEFAULT NULL,
  `createdby` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `process` (
  ...
  `salesorderid` int(11) DEFAULT NULL,
  `invoiceid` int(11) DEFAULT NULL,
  `prepaymentinvoiceid` int(11) DEFAULT NULL,
  `deliveryorderid` int(11) DEFAULT NULL,
  `creditnoteid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `purchaseorder` (
  ...
  `salesorderid` int(11) DEFAULT NULL,
  `invoiceid` int(11) DEFAULT NULL,
  `quoterequestid` int(11) DEFAULT NULL,
  `contactid` int(11) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `subject` varchar(255) DEFAULT NULL,
  `reference` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `shop` (
  ...
  `smtpuser` varchar(255) DEFAULT NULL,
  `smtppass` varchar(32) DEFAULT NULL,
  `catalogenabled` tinyint(1) NOT NULL DEFAULT 0,
  `checkoutenabled` tinyint(1) NOT NULL DEFAULT 0,
  `contactenabled` tinyint(1) NOT NULL DEFAULT 0,
