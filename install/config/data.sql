...
(1, '1', 'Gutschrift-%NUMBER%.pdf', 'Lieferschein-%NUMBER%.pdf', 'Rechnung-%NUMBER%.pdf', 'Bestellung-%NUMBER%.pdf', 'Angebot-%NUMBER%.pdf', 'Anfrage-%NUMBER%.pdf', 'Mahnung-%NUMBER%.pdf', 'Auftragsbestaetigung-%NUMBER%.pdf', 'de_DE'),
(2, '1', 'Credit-Note-%NUMBER%.pdf', 'Delivery-Order-%NUMBER%.pdf', 'Invoice-%NUMBER%.pdf', 'Purchase-Order-%NUMBER%.pdf', 'Quote-%NUMBER%.pdf', 'Quote-Request-%NUMBER%.pdf', 'Reminder-%NUMBER%.pdf', 'Sales-Order-%NUMBER%.pdf', 'en_US');
...
INSERT INTO `user` (`id`, `username`, `password`, `name`, `email`, `admin`, `smtphost`, `smtpauth`, `smtpsecure`, `smtpuser`, `smtppass`, `clientid`, `created`, `createdby`, `modified`, `modifiedby`, `locked`, `lockedtime`, `activated`, `deleted`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin', NULL, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, 0, NULL, 0, 0, NULL, 1, 0);
