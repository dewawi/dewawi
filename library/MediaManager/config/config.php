...
$config = array(
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => array( '../images/300/', '../images/400/', '../images/500/' ), //fixed path of the image folder from the current position on upload folder
    'fixed_image_creation_name_to_prepend'    => array( '', '', '' ), //name to prepend on filename
    'fixed_image_creation_to_append'          => array( '_300', '_400', '_500' ), //name to appendon filename
    'fixed_image_creation_width'              => array( 300, 400, 500 ), //width of image
    'fixed_image_creation_height'             => array( 300, 400, 500 ), //height of image
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
    ...
    #                          4 / crop= resize and crop;
    */
    'fixed_image_creation_option'             => array( 'auto', 'auto', 'auto' ), //set the type of the crop
    ...
    'relative_path_from_current_pos'          => array( '300/', '500/', '800/', '1000/' ), //relative path of the image folder from the current position on upload folder
    ...
    'relative_image_creation_width'           => array( 300, 500, 800, 1000 ), //width of image
    'relative_image_creation_height'          => array( 300, 500, 800, 1000 ), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
     ...
     *              4 / crop= resize and crop;
     */
    'relative_image_creation_option'          => array( 'auto', 'auto', 'auto', 'auto' ), //set the type of the crop
