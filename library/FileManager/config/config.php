...
//echo $current_path;
//echo $_SESSION['FileManager']['subfolder'];

$writable = false;
if(isset($_SESSION['FileManager']['writable']) && $_SESSION['FileManager']['writable']) $writable = true;
...
$config = array(
    ...
    */
    ...
    // YOU CAN ALSO PASS THIS PARAMETERS USING SESSION VAR => $_SESSION['FileManager']["VIEW"]=
    //
    //******************
    'default_view'                            => 0,
