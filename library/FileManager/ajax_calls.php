    ...
    switch ($_GET['action']) {
        ...
        case 'sort':
            if (isset($_GET['sort_by'])) {
                $session["sort_by"] = $_GET['sort_by'];
            }

			if (isset($_GET['descending']))
			{
				$session["descending"] = $_GET['descending'];
			}
			break;
		case 'save_img':
        ...
        case 'copy_cut':
            ...
            $session['clipboard']['path'] = $_POST['path'];
            $session['clipboard_action'] = $_POST['sub_action'];
            break;
