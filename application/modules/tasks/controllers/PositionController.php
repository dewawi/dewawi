...
class Tasks_PositionController extends DEEC_Controller_PositionAction
{
	...
	public function indexAction()
	{
		...
		foreach($positions as $position) {
			...
			foreach($forms[$position->id] as $element) {
				...
				if(!$task['editpositionsseparately']) $element->setAttrib('disabled', 'disabled');
			}
		}
		$this->view->forms = $forms;
		$this->view->toolbar = new Tasks_Form_ToolbarPositions();
	}
	...
	public function applyAction()
	{
		...
		if($request->isPost()) {
			...
			if($params['itemid'] && $params['parentid']) {
				...
				$position = new Tasks_Model_DbTable_Taskpos();
	...
	public function addAction()
	{
		...
		$parentClass = 'Tasks_Model_DbTable_'.ucfirst($params['parent']);
		$positionClass = 'Tasks_Model_DbTable_'.ucfirst($params['parent'].$params['type']);
	...
	public function editAction()
	{
		...
		//Define belonging classes
		$formClass = 'Tasks_Form_'.ucfirst($params['parent'].$params['type']);
		$modelClass = 'Tasks_Model_DbTable_'.ucfirst($params['parent'].$params['type']);
