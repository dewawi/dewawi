...
class Shops_Model_DbTable_Pricerulepos extends Zend_Db_Table_Abstract
{

	protected $_name = 'pricerulepos';
	...
	public function getPositions($module, $controller, $parentid)
	{
