...
class Shops_Form_Order extends Zend_Form
{
	public function init()
	{
		...
		$form['userid']->setLabel('SHOPS_USER_ID')
			->setRequired(true)
			->addFilter('StripTags')
		...
		$form['orderid']->setLabel('SHOPS_ORDER_ID')
			->addFilter('StripTags')
			->addFilter('StringTrim')
			->setAttrib('size', '20');

		$form['contactid'] = new Zend_Form_Element_Text('contactid');
		$form['contactid']->setLabel('SHOPS_CONTACT_ID')
			->addFilter('StripTags')
			->addFilter('StringTrim')
			->setAttrib('size', '20');

		$form['invoiceid'] = new Zend_Form_Element_Text('invoiceid');
		$form['invoiceid']->setLabel('SHOPS_INVOICE_ID')
			->addFilter('StripTags')
			->addFilter('StringTrim')
			->setAttrib('size', '20');
