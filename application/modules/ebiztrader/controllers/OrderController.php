...
class Ebiztrader_OrderController extends Zend_Controller_Action
{
	...
	public function addAction()
	{
		...
		if($request->isPost()) {
			...
			if($form->isValid($data)) {
				$orderDb = new Ebiztrader_Model_DbTable_Order();
				$id = $orderDb->addOrder($data);
				echo Zend_Json::encode($orderDb->getOrder($id));
			} else {
