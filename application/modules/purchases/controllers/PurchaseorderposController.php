...
class Purchases_PurchaseorderposController extends Zend_Controller_Action
{
	...
	public function applyAction()
	{
		...
		if($request->isPost()) {
			...
			if($itemid && $purchaseorderid) {
				...
				//Calculate
				$this->_helper->Calculate($purchaseorderid, $this->_currency, $this->_date, $this->_user['id']);
			} else {
	...
	public function copyAction()
	{
		...
		if($request->isPost()) {
			...
			//Calculate
			$this->_helper->Calculate($data['purchaseorderid'], $this->_currency, $this->_date, $this->_user['id']);
		}
	}
