		...
		<?php } else {
			if(count($this->view->history['quotes'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="quoteid"><?php echo $this->view->translate('QUOTES_QUOTE_ID') ?></th>
							<th class="title"><?php echo $this->view->translate('QUOTES_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('QUOTES_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('QUOTES_CONTACT') ?></th>
							<th class="quotedate"><?php echo $this->view->translate('QUOTES_QUOTE_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('QUOTES_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('QUOTES_MODIFIED') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('QUOTES_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('QUOTES_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('QUOTES_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="notes">
								<?php if($quote->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="quote" data-id="<?php echo $quote->id; ?>" data-value="<?php echo $quote->notes; ?>" data-type="textarea"><?php echo $quote->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="quote" data-id="<?php echo $quote->id; ?>" data-value="<?php echo $quote->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
			...
			<?php if(count($this->view->history['salesorders'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="salesorderid"><?php echo $this->view->translate('SALES_ORDERS_SALES_ORDER_ID') ?></th>
							<th class="title"><?php echo $this->view->translate('SALES_ORDERS_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('SALES_ORDERS_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('SALES_ORDERS_CONTACT') ?></th>
							<th class="salesorderdate"><?php echo $this->view->translate('SALES_ORDERS_SALES_ORDER_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('SALES_ORDERS_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('SALES_ORDERS_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('SALES_ORDERS_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('SALES_ORDERS_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('SALES_ORDERS_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('SALES_ORDERS_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="salesorderdate">
								<?php echo $this->view->escape($salesorder->salesorderdate);?>
							</td>
							<td class="notes">
								<?php if($salesorder->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="salesorder" data-id="<?php echo $salesorder->id; ?>" data-value="<?php echo $salesorder->notes; ?>" data-type="textarea"><?php echo $salesorder->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="salesorder" data-id="<?php echo $salesorder->id; ?>" data-value="<?php echo $salesorder->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
							...
							<td class="deliverydate">
								<?php if($salesorder->deliverydate) echo $this->view->escape($salesorder->deliverydate); ?>
							</td>
							<td class="subtotal">
			...
			<?php if(count($this->view->history['invoices'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="invoiceid"><?php echo $this->view->translate('INVOICES_INVOICE_ID'); ?></th>
							<th class="title"><?php echo $this->view->translate('INVOICES_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('INVOICES_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('INVOICES_CONTACT') ?></th>
							<th class="invoicedate"><?php echo $this->view->translate('INVOICES_INVOICE_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('INVOICES_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('INVOICES_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('INVOICES_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('INVOICES_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('INVOICES_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('INVOICES_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="notes">
								<?php if($invoice->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="invoice" data-id="<?php echo $invoice->id; ?>" data-value="<?php echo $invoice->notes; ?>" data-type="textarea"><?php echo $invoice->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="invoice" data-id="<?php echo $invoice->id; ?>" data-value="<?php echo $invoice->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
							...
							<td class="deliverydate">
								<?php if($invoice->deliverydate) echo $this->view->escape($invoice->deliverydate); ?>
							</td>
							<td class="subtotal">
			...
			<?php if(count($this->view->history['deliveryorders'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="deliveryorderid"><?php echo $this->view->translate('DELIVERY_ORDERS_DELIVERY_ORDER_ID'); ?></th>
							<th class="title"><?php echo $this->view->translate('DELIVERY_ORDERS_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('DELIVERY_ORDERS_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('DELIVERY_ORDERS_CONTACT') ?></th>
							<th class="deliveryorderdate"><?php echo $this->view->translate('DELIVERY_ORDERS_DELIVERY_ORDER_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('DELIVERY_ORDERS_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('DELIVERY_ORDERS_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('DELIVERY_ORDERS_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('DELIVERY_ORDERS_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('DELIVERY_ORDERS_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('DELIVERY_ORDERS_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="deliveryorderdate">
								<?php echo $this->view->escape($deliveryorder->deliveryorderdate);?>
							</td>
							<td class="notes">
								<?php if($deliveryorder->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="deliveryorder" data-id="<?php echo $deliveryorder->id; ?>" data-value="<?php echo $deliveryorder->notes; ?>" data-type="textarea"><?php echo $deliveryorder->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="deliveryorder" data-id="<?php echo $deliveryorder->id; ?>" data-value="<?php echo $deliveryorder->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
							...
							<td class="deliverydate">
								<?php if($deliveryorder->deliverydate) echo $this->view->escape($deliveryorder->deliverydate); ?>
							</td>
							<td class="subtotal">
			...
			<?php if(count($this->view->history['creditnotes'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="creditnoteid"><?php echo $this->view->translate('CREDIT_NOTES_CREDIT_NOTE_ID'); ?></th>
							<th class="title"><?php echo $this->view->translate('CREDIT_NOTES_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('CREDIT_NOTES_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('CREDIT_NOTES_CONTACT') ?></th>
							<th class="creditnotedate"><?php echo $this->view->translate('CREDIT_NOTES_CREDIT_NOTE_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('CREDIT_NOTES_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('CREDIT_NOTES_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('CREDIT_NOTES_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('CREDIT_NOTES_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('CREDIT_NOTES_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('CREDIT_NOTES_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="creditnotedate">
								<?php echo $this->view->escape($creditnote->creditnotedate);?>
							</td>
							<td class="notes">
								<?php if($creditnote->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="creditnote" data-id="<?php echo $creditnote->id; ?>" data-value="<?php echo $creditnote->notes; ?>" data-type="textarea"><?php echo $creditnote->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="creditnote" data-id="<?php echo $creditnote->id; ?>" data-value="<?php echo $creditnote->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
							...
							<td class="deliverydate">
								<?php if($creditnote->deliverydate) echo $this->view->escape($creditnote->deliverydate); ?>
							</td>
							<td class="subtotal">
			...
			<?php if(count($this->view->history['quoterequests'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="quoterequestid"><?php echo $this->view->translate('QUOTE_REQUESTS_QUOTE_REQUEST_ID'); ?></th>
							<th class="title"><?php echo $this->view->translate('QUOTE_REQUESTS_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('QUOTE_REQUESTS_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('QUOTE_REQUESTS_CONTACT') ?></th>
							<th class="quoterequestdate"><?php echo $this->view->translate('QUOTE_REQUESTS_QUOTE_REQUEST_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('QUOTE_REQUESTS_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('QUOTE_REQUESTS_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('QUOTE_REQUESTS_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('QUOTE_REQUESTS_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('QUOTE_REQUESTS_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('QUOTE_REQUESTS_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="quoterequestdate">
								<?php echo $this->view->escape($quoterequest->quoterequestdate);?>
							</td>
							<td class="notes">
								<?php if($quoterequest->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="quoterequest" data-id="<?php echo $quoterequest->id; ?>" data-value="<?php echo $quoterequest->notes; ?>" data-type="textarea"><?php echo $quoterequest->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="quoterequest" data-id="<?php echo $quoterequest->id; ?>" data-value="<?php echo $quoterequest->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
							...
							<td class="deliverydate">
								<?php if($quoterequest->deliverydate) echo $this->view->escape($quoterequest->deliverydate); ?>
							</td>
							<td class="subtotal">
			...
			<?php if(count($this->view->history['purchaseorders'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="purchaseorderid"><?php echo $this->view->translate('PURCHASE_ORDERS_PURCHASE_ORDER_ID'); ?></th>
							<th class="title"><?php echo $this->view->translate('PURCHASE_ORDERS_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('PURCHASE_ORDERS_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('PURCHASE_ORDERS_CONTACT') ?></th>
							<th class="purchaseorderdate"><?php echo $this->view->translate('PURCHASE_ORDERS_PURCHASE_ORDER_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('PURCHASE_ORDERS_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('PURCHASE_ORDERS_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('PURCHASE_ORDERS_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('PURCHASE_ORDERS_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('PURCHASE_ORDERS_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('PURCHASE_ORDERS_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="purchaseorderdate">
								<?php echo $this->view->escape($purchaseorder->purchaseorderdate);?>
							</td>
							<td class="notes">
								<?php if($purchaseorder->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="purchaseorder" data-id="<?php echo $purchaseorder->id; ?>" data-value="<?php echo $purchaseorder->notes; ?>" data-type="textarea"><?php echo $purchaseorder->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="purchaseorder" data-id="<?php echo $purchaseorder->id; ?>" data-value="<?php echo $purchaseorder->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
							...
							<td class="deliverydate">
								<?php if($purchaseorder->deliverydate) echo $this->view->escape($purchaseorder->deliverydate); ?>
							</td>
							<td class="subtotal">
			...
			<?php if(count($this->view->history['processes'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="id"><?php echo $this->view->translate('PROCESSES_ID'); ?></th>
							<th class="title"><?php echo $this->view->translate('PROCESSES_TITLE') ?></th>
							<th class="customerid"><?php echo $this->view->translate('PROCESSES_CUSTOMER_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('PROCESSES_CUSTOMER') ?></th>
							<th class="notes"><?php echo $this->view->translate('PROCESSES_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('PROCESSES_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('PROCESSES_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('PROCESSES_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('PROCESSES_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('PROCESSES_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="notes">
								<?php if($process->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="process" data-id="<?php echo $process->id; ?>" data-value="<?php echo $process->notes; ?>" data-type="textarea"><?php echo $process->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="process" data-id="<?php echo $process->id; ?>" data-value="<?php echo $process->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
							...
							<td class="deliverydate">
								<?php if($process->deliverydate) echo $this->view->escape($process->deliverydate); ?>
							</td>
							<td class="subtotal">
			...
			<?php if(count($this->view->history['reminders'])) : ?>
				...
				<table id="data">
					<thead>
						<tr>
							<th class="reminderid"><?php echo $this->view->translate('REMINDERS_REMINDER_ID'); ?></th>
							<th class="title"><?php echo $this->view->translate('REMINDERS_TITLE') ?></th>
							<th class="contactid"><?php echo $this->view->translate('REMINDERS_CONTACT_ID') ?></th>
							<th class="contact"><?php echo $this->view->translate('REMINDERS_CONTACT') ?></th>
							<th class="reminderdate"><?php echo $this->view->translate('REMINDERS_REMINDER_DATE') ?></th>
							<th class="notes"><?php echo $this->view->translate('REMINDERS_NOTES') ?></th>
							<th class="modified"><?php echo $this->view->translate('REMINDERS_MODIFIED') ?></th>
							<th class="deliverydate"><?php echo $this->view->translate('REMINDERS_DELIVERY_DATE') ?></th>
							<th class="subtotal"><?php echo $this->view->translate('REMINDERS_SUBTOTAL') ?></th>
							<th class="total"><?php echo $this->view->translate('REMINDERS_TOTAL') ?></th>
							<th class="state"><?php echo $this->view->translate('REMINDERS_STATE') ?></th>
							<th class="buttons"></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td class="reminderdate">
								<?php echo $this->view->escape($reminder->reminderdate);?>
							</td>
							<td class="notes">
								<?php if($reminder->notes) : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="reminder" data-id="<?php echo $reminder->id; ?>" data-value="<?php echo $reminder->notes; ?>" data-type="textarea"><?php echo $reminder->notes; ?></pre>
								<?php else : ?>
									<pre class="editable" data-name="notes" data-module="sales" data-controller="reminder" data-id="<?php echo $reminder->id; ?>" data-value="<?php echo $reminder->notes; ?>" data-type="textarea" data-empty="true"><?php echo $this->view->translate('TOOLBAR_NEW') ;?></pre>
								<?php endif; ?>
							</td>
							<td class="modified">
