...
class Processes_Controller_Action_Helper_Params extends Zend_Controller_Action_Helper_Abstract
{
	public function getParams($toolbar, $options)
	{
		...
		$params['paymentstatus'] = $request->getParam('paymentstatus', $request->getCookie('paymentstatus', $toolbar->getDefault('paymentstatus')));
		if(!is_array($params['paymentstatus'])) $params['paymentstatus'] = Zend_Json::decode($params['paymentstatus']);
		$toolbar->setValue('paymentstatus', $params['paymentstatus']);
