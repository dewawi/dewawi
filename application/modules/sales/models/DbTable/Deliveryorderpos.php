...
class Sales_Model_DbTable_Deliveryorderpos extends Zend_Db_Table_Abstract
{

	protected $_name = 'deliveryorderpos';
	...
	public function getPositions($deliveryorderid)
	{
		...
		if (!$data) {
			throw new Exception("Could not find row $deliveryorderid");
		}
		return $data;
	}
