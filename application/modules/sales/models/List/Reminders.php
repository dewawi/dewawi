...
class Sales_Model_List_Reminders extends DEEC_List
{
	...
	protected function buildColumns()
	{
		return [
			...
			[
				...
				'label' => 'REMINDERS_BILLING_ADDRESS',
				'type' => 'address',
				'fields' => [
					'billingstreet',
					'billingpostcode',
			...
			[
				'name' => 'reminderdate',
				'label' => 'REMINDERS_REMINDER_DATE',
				'type' => 'date',
				'format' => 'd.m.Y',
			],
			[
				'name' => 'total',
				'label' => 'REMINDERS_TOTAL',
			],
			[
				'name' => 'state',
				...
				'editable' => function ($reminder) {
					return !in_array((string)$reminder->state, ['105', '106'], true);
				},
				'badge_map' => [
