...
class Sales_Form_Deliveryorder extends DEEC_Form
{
	public function __construct()
	{
		...
		$this->addElement([
			'name' => 'billingname2',
			'type' => 'text',
			'label' => 'DELIVERY_ORDERS_CONTACT_NAME2',
			'format' => ['type' => 'string'],
			'tab' => 'customer',
			'col' => 6,
		]);
		...
		$this->addElement([
			'name' => 'shippingname2',
			'type' => 'text',
			'label' => 'DELIVERY_ORDERS_SHIPPING_NAME2',
			'format' => ['type' => 'string'],
			'tab' => 'shipping',
			'col' => 6,
		]);
		...
		$this->addElement([
			'name' => 'pdfshowimages',
			'type' => 'checkbox',
			'label' => 'DELIVERY_ORDERS_PDF_SHOW_IMAGES',
			'format' => ['type' => 'int'],
			'tab' => 'finish',
			'default' => 0,
			'col' => 3,
		...
		$this->addElement([
			...
			'type' => 'checkbox',
			'label' => 'DELIVERY_ORDERS_PDF_SHOW_POSITION_IMAGES',
			'format' => ['type' => 'int'],
			'tab' => 'finish',
			'default' => 0,
			'col' => 3,
