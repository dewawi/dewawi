...
class Sales_CreditnoteposController extends Zend_Controller_Action
{
	...
	public function applyAction()
	{
		...
		if($request->isPost()) {
			...
			if($itemid && $creditnoteid) {
				...
				//Calculate
				$this->_helper->Calculate($creditnoteid, $this->_currency, $this->_date, $this->_user['id']);
			} else {
	...
	public function copyAction()
	{
		...
		if($request->isPost()) {
			...
			//Calculate
			$this->_helper->Calculate($data['creditnoteid'], $this->_currency, $this->_date, $this->_user['id']);
		}
	}
