...
class Sales_SalesorderposController extends Zend_Controller_Action
{
	...
	public function applyAction()
	{
		...
		if($request->isPost()) {
			...
			if($itemid && $salesorderid) {
				...
				//Calculate
				$this->_helper->Calculate($salesorderid, $this->_currency, $this->_date, $this->_user['id']);
			} else {
	...
	public function copyAction()
	{
		...
		if($request->isPost()) {
			...
			//Calculate
			$this->_helper->Calculate($data['salesorderid'], $this->_currency, $this->_date, $this->_user['id']);
		}
	}
