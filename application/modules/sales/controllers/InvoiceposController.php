...
class Sales_InvoiceposController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		//Get positions
		$positions = $this->getPositions($invoiceid);
	...
	public function selectAction()
	{
		...
		$positions = new Sales_Model_DbTable_Invoicepos();
	...
	public function applyAction()
	{
		...
		if($request->isPost()) {
			...
			if($itemid && $invoiceid) {
				...
				//Calculate
				$this->_helper->Calculate($invoiceid, $this->_currency, $this->_date, $this->_user['id']);
			} else {
	...
	public function copyAction()
	{
		...
		if($request->isPost()) {
			...
			//Calculate
			$this->_helper->Calculate($data['invoiceid'], $this->_currency, $this->_date, $this->_user['id']);
		}
	}
	...
	protected function getPositions($invoiceid)
	{
