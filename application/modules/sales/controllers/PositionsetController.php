...
class Sales_PositionsetController extends Zend_Controller_Action
{
	...
	public function editAction()
	{
		...
		$form->ordering->addMultiOptions($this->_helper->Ordering->getOrdering($params['parentid'], $params['id']));
	...
	public function sortAction()
	{
		...
		if($request->isPost()) {
			$data = $request->getPost();
			$this->_helper->OrderingSet->sortOrdering($data['id'], $params['parentid'], $data['ordering']);
		}
	}
