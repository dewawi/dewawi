...
class Zend_View_Helper_AdminMenu extends Zend_View_Helper_Abstract
{
	public function AdminMenu() { ?>
		<ul>
			...
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'export', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_EXPORT'); ?></a></li>
		</ul>
		...
		<ul>
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'paymentmethod', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_PAYMENT_METHODS'); ?></a></li>
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'currency', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_CURRENCIES'); ?></a></li>
		</ul>
		<h4><?php echo $this->view->translate('ADMIN_DELIVERY'); ?></h4>
		<ul>
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'shippingmethod', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_SHIPPING_METHODS'); ?></a></li>
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'deliverytime', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_DELIVERY_TIMES'); ?></a></li>
		</ul>
		...
		<ul>
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'template', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_TEMPLATES'); ?></a></li>
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'footer', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_FOOTERS'); ?></a></li>
		</ul>
		...
		<ul>
			...
			<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'media', 'action'=>'index', 'type'=>'slide', 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_SLIDES'); ?></a></li>

		</ul>
		<?php if($this->view->user['admin']) : ?>
			<h4><?php echo $this->view->translate('ADMIN_SYSTEM'); ?></h4>
			<ul>
				<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'info', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_INFO'); ?></a></li>
				<li><a href="<?php echo $this->view->url(array('module'=>'admin', 'controller'=>'module', 'action'=>'index', 'type'=>null, 'id'=>null)); ?>"><?php echo $this->view->translate('ADMIN_MODULES'); ?></a></li>
			</ul>
		<?php endif; ?>
		<br>
		<br>
