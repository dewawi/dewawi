...
class Admin_ExportController extends Zend_Controller_Action
{
	...
	protected function getAllTableNames($type)
	{
		...
		$tablesToExport = ['address', 'bankaccount', 'category', 'comment', 'contact', 'creditnote', 'creditnotepos', 'creditnoteposset', 'deliveryorder', 'deliveryorderpos', 'deliveryorderposset', 'deliverytime', 'email', 'emailmessage', 'emailtemplate', 'footer', 'increment', 'internet', 'inventory', 'invoice', 'invoicepos', 'invoiceposset', 'item', 'itemattribute', 'itemoption', 'paymentmethod', 'permission', 'phone', 'pricerule', 'pricerulepos', 'process', 'processpos', 'processposset', 'purchaseorder', 'purchaseorderpos', 'purchaseorderposset', 'quote', 'quotepos', 'quoteposset', 'reminder', 'reminderpos', 'reminderposset', 'salesorder', 'salesorderpos', 'salesorderposset', 'shippingmethod', 'state', 'tag', 'tagentity', 'task', 'taskpos', 'taskposset', 'taxrate', 'template', 'textblock', 'uom', 'user', 'usertracking', 'warehouse'];
		$clientidTables = [];
