...
class Application_Model_DbTable_Taxrate extends Zend_Db_Table_Abstract
{
	...
	public function addTaxrate($opportunityid, $contactid, $title, $orderdate, $deliverydate, $clientid, $created)
	{
		$data = array(
	...
	public function updateTaxrate($id, $taxrateid, $opportunityid)
	{
		$data = array(
			'taxrateid' => $taxrateid,
			'opportunityid' => $opportunityid,
