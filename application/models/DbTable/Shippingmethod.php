...
class Application_Model_DbTable_Shippingmethod extends Zend_Db_Table_Abstract
{
	...
	public function addShippingmethod($opportunityid, $contactid, $title, $orderdate, $deliverydate, $clientid, $created)
	{
		$data = array(
	...
	public function updateShippingmethod($id, $uomid, $opportunityid)
	{
		$data = array(
			'uomid' => $uomid,
			'opportunityid' => $opportunityid,
