...
class Application_Model_DbTable_Paymentmethod extends Zend_Db_Table_Abstract
{
	...
	public function addPaymentmethod($opportunityid, $contactid, $title, $orderdate, $deliverydate, $clientid, $created)
	{
		$data = array(
	...
	public function updatePaymentmethod($id, $uomid, $opportunityid)
	{
		$data = array(
			'uomid' => $uomid,
			'opportunityid' => $opportunityid,
